if (game:GetService("CoreGui")):FindFirstChild("SpyderX") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).SpyderX:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(100, 100, 100);
_G.Dark = Color3.fromRGB(22, 22, 26);
_G.Third = Color3.fromRGB(251, 255, 0);
...
ImageButton1.MouseButton1Down:connect(function()
    (game.CoreGui:FindFirstChild("SpyderX")).Enabled = not (game.CoreGui:FindFirstChild("SpyderX")).Enabled;
    sound:Play()
end)
...
function ChiuMyLy:Notify(desc)
	...
	Image.Image = "rbxassetid://103733198839928";
	Title.Parent = Frame;
...
function ChiuMyLy:StartLoad()
	...
	LoadingBar.BackgroundColor3 = Color3.fromRGB(251, 255, 0);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("SpyderX") then
			makefolder("SpyderX");
		end;
		if not isfolder("SpyderX/Library/") then
			makefolder("SpyderX/Library/");
		end;
		if not isfile(("SpyderX/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("SpyderX/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("SpyderX/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("SpyderX/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("SpyderX/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
(getgenv()).LoadConfig();
function ChiuMyLy:SaveSettings()
	if SettingsLib.SaveSettings then
		return true;
	end;
	return false;
end;
function ChiuMyLy:LoadAnimation()
	if SettingsLib.LoadAnimation then
		return true;
	end;
	return false;
end;
function ChiuMyLy:Window(Config)
	...
	local SpyderX = Instance.new("ScreenGui");
	SpyderX.Name = "SpyderX";
	SpyderX.Parent = game.CoreGui;
	SpyderX.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = SpyderX;
	...
	function CreateCheckbox(title, state, callback)
		...
		Checkbox.MouseButton1Click:Connect(function()
			...
			if checked then
				...
				Checkbox.BackgroundColor3 = Color3.fromRGB(251, 255, 0);
			else
				Checkbox.ImageTransparency = 1;
				Checkbox.BackgroundColor3 = Color3.fromRGB(100, 100, 100);
			end;
	...
	function CreateButton(title, callback)
		...
		Button.BackgroundColor3 = Color3.fromRGB(251, 255, 0);
	...
	CreateButton("Reset Config", function()
		if isfolder("SpyderX") then
			delfolder("SpyderX");
		end;
		ChiuMyLy:Notify("Config has been reseted!");
	end);
	...
	function uitab:Tab(text, img)
		...
		function main:Seperator(text)
			...
			Sep1.RichText = true;
			Sep1.Text = "〈<font color=\"rgb(251, 255, 0)\">〈</font>";
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(251, 255, 0)\">〉</font>〉";
